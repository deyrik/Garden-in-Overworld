...
if __name__ == "__main__":
    ...
    fazendeiro.solicita_nickname("Steve")
    ...
    while True:
        time.sleep(2)
        #pega x e y aleatórios para colher dentro dos limites do mapa
        print("Digite a corenada x")
        x = int(input())
        print("Digite a corenada y")
        y = int(input())
        fazendeiro.solicita_colher(6, x, y)
        fazendeiro.solicita_colher(7, x, y)
