...
class ClienteFazenda:
    ...
    def escutar_servidor(self):
        ...
        #ignorar e a Thread continua viva , isso é  quando tem \n\n se acontecer
        if mensagem == "":
            return {"tipo": "IGNORAR"}
        try:
            ...
            elif comando_servidor == "NOVO_JOGADOR":
                return {"tipo": "NOVO_JOGADOR", "nome": dados.get("nome")}
                
            elif comando_servidor == "JOGADOR_SAIU":
                return {"tipo": "JOGADOR_SAIU", "nome": dados.get("nome")}
